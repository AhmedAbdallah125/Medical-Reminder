...
public class TakerRefillWindow {
    ...
    String email;
    public TakerRefillWindow(Context context, String data,String email) {
    ...
    private void setBinding() {
        ...
        binding.titleText.setText("Refill " + medicationPOJO.getMedicationName() + " for your patient "+ email.split("@")[0]+" before finish!");
